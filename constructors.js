...
Movie.prototype.changeRating = function(num1){
  let newRating = (this.rating + num1)/2;
    return newRating;
}
  ...
  User.prototype.addSavedPost = function(num2,str,stars){
    let newSavedPost = {
      id: num2,
      title: str,
      rating: stars
  ...
  User.prototype.removeSavedPost = function (num3){
  ...
  User.prototype.changePostRating = function(num1,num2){
    let objectId = this.savedPosts.find(function(element){
      return element.id === num1;
    })
    return objectId.rating = num2;
  }
